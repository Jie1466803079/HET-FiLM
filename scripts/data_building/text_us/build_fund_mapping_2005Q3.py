"""
Build the id_idx -> crsp_portno -> crsp_fundno mapping for
graphs_v2_portfolio_clean_with_ids_since_2005Q3.pkl.

Same logic as build_fund_mapping.py but targeting the 2005Q3 graph.
...
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "fund_mapping_since2005Q3.csv")
