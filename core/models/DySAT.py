...
class DySAT(nn.Module):
    ...
    def encode(self, graphs, *args, **kwargs):
        ...
        for t in range(0, self.num_time_steps):
            ...
            if use_ew_message():
                # weight vector aligned with the homogeneous edge order;
                # StructuralAttentionLayer2 scales messages when present
                data.edge_weight = build_edge_weight_vector(snapshot, e_dict)
