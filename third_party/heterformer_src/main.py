...
parser.add_argument("--data_path", type=str, default="data/book")  # MFP: removed choices=['data/book'] — vendored upstream constraint; we use full paths
parser.add_argument("--model_dir", type=str, default='ckpt/book')  # MFP: removed choices=['ckpt/book']
...
parser.add_argument("--pretrain_dir", default="data/book/pretrain_embed", type=str)  # MFP: removed choices=['data/book/pretrain_embed']
